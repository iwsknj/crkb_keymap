...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_LOWER] = LAYOUT(\
        ...
        //,-----------------------------------------------------.                    ,-----------------------------------------------------.
            KC_LSFT, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,                                KC_PIPE, KC_GRV, KC_NO, KC_LBRC, KC_RBRC, KC_UNDS, \
        //,-----------------------------------------------------.                    ,-----------------------------------------------------
        ...
        //,-----------------------------------------------------.                    ,-----------------------------------------------------.
        // LSFT, xxx, xxx, xxx, xxx, xxx,                                              |, `, xxx, [, ], _,
        //,-----------------------------------------------------.                    ,-----------------------------------------------------
    ...
    [_RAISE] = LAYOUT(\
        ...
        //,-----------------------------------------------------.                    ,-----------------------------------------------------.
            KC_ESC, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5,                                 KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_NO, KC_NO, \
        //,-----------------------------------------------------.                    ,-----------------------------------------------------.
            KC_LSFT, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10,                               KC_HOME, KC_PGDN, KC_PGUP, KC_END, KC_F11, KC_F12, \
        //,-----------------------------------------------------.                    ,-----------------------------------------------------.
            KC_LGUI, LOWER, KC_SPC,                                                    KC_ENT, RAISE, KC_RALT \
        //,-----------------------------------------------------.                    ,-----------------------------------------------------.
        ...
        //,-----------------------------------------------------.                    ,-----------------------------------------------------.
        // ESC, F1, F2, F3, F4, F5,                                                    ←, ↓, ↑, →, xxx, xxx,
        //,-----------------------------------------------------.                    ,-----------------------------------------------------.
        // Shift, F6, F7, F8, F9, F10,                                                 HOME, Page Down, Page Up, END, F11, F12,
        //,-----------------------------------------------------.                    ,-----------------------------------------------------.
        // Command, LOWER, Space,                                                      Enter, RAISE, Option
        //,-----------------------------------------------------.                    ,-----------------------------------------------------.
    ),
